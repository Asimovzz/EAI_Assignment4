    ...
    def run(self):
        ...
        if cfg.training.resume:
            ...
            if lastest_ckpt_path.is_file():
                ...
                exclude_keys = None
                include_keys = None
                if not cfg.training.get("resume_optimizer", True):
                    exclude_keys = ("optimizer",)
                if not cfg.training.get("resume_training_state", True):
                    include_keys = ()
                self.load_checkpoint(path=lastest_ckpt_path, exclude_keys=exclude_keys, include_keys=include_keys)
